...
if sdk_config.get("PARTITION_TABLE_SINGLE_APP", False):
    partitions_csv = board.get("build.partitions", "partitions_singleapp.csv")
elif sdk_config.get("PARTITION_TABLE_TWO_OTA", False):
    partitions_csv = board.get("build.partitions", "partitions_two_ota.csv")
elif sdk_config.get("PARTITION_TABLE_CUSTOM", False):
    partitions_csv = sdk_config.get("PARTITION_TABLE_FILENAME")
