...
### Development build supporting Arduino 3.0.0 and IDF 5.1
alpha Arduino Core 3.0.0 and can be used with Platformio for the ESP32/ESP32solo1, ESP32C2, ESP32C3, ESP32S2, ESP32S3 and ESP32-H2
```                  
[platformio]
